...
-- in { Type = StepperConfig.Type
--         //\\ KlipperConfigSection StepperConfig.Type
--     , default = StepperConfig.default
--         //\\ { toKlipperConfigSection = (toKlipperConfigSection StepperConfig.Type) }
--     }
in
    { Type = StepperConfig.Type
    , default = StepperConfig.default
    , NamedStepper = NamedStepper
